# ====================================================================================
# Setup Project
PROJECT_NAME := crossplane-provider-codefresh
...
XPKGS = provider-codefresh
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-codefresh: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider CodeFresh CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider CodeFresh controllers
...
# This target prepares repo for your provider by replacing all "codefresh"
